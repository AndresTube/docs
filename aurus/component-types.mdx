...
description: "All available component types: TEXT, BUTTON, INPUT, ITEM, BLOCK, ENTITY, PLAYER"
icon: "shapes"
---
...
<AccordionGroup>
  <Accordion title="Text-to-text hover">
    Changes text and color on hover:
  ...
  <Accordion title="Text-to-item hover">
    Swaps from text to an item display on hover:
...
<Note>All text fields support MiniMessage tags (like red, gradient, etc.) and legacy section-sign codes. PlaceholderAPI placeholders are also supported.</Note>
